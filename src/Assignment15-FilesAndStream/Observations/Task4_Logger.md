...
3. Using a single shared log file can reduce performance during concurrent loggingg.
...
1. Locked loggingg prevented concurrency issues but introduced some waiting between threads.
